...
PROVIDES a common agent-run setup — coding-agent selection (Claude Code, Codex, Gemini), provider and runtime routing (Anthropic API, Bedrock, Vertex, OpenAI / cloud review, and further providers), agent plugin and marketplace installation, and tool-allowlist composition
