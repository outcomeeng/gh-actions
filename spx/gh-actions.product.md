...
- ALWAYS: pin every action and reusable workflow referenced by `uses:` by full-length commit SHA with a trailing tag or branch comment — mutable references can be redirected after publication ([review])
