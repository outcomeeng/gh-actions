...
Deterministic Python in the `gh_actions` package (keychain reads, repository detection, caller-workflow drift checks) is unit-testable and gets a pytest lane like any code.
