...
- **plugins/spx cross-reference.** The review gate's prompt taxonomy and reviewer-only decision are governed in `plugins/spx` and cross-referenced, never restated.
