...
- **plugins/spx cross-reference.** The review gate's prompt taxonomy (`plugins/spx/21-spec-tree.enabler/68-reviewing.enabler/reviewing.md`) and reviewer-only decision (`plugins/spx/15-merging.pdr.md`) are cross-referenced at those paths, never restated.
